...
const Certifications = () => {
  ...
  // Utiliser useMemo pour éviter la recréation du tableau
  const certifications = useMemo(() => [
    {
      ...
      description: "Certification Cisco couvrant les fondamentaux des réseaux informatiques",
    ...
    },
    {
      ...
      description: "Certification Microsoft Azure validant les connaissances cloud",
    ...
    },
    {
      ...
      description: "Certification Python pour la programmation avancée",
  ...
  // Calculer les certifications filtrées avec useMemo
  ...
  // Calculer les catégories avec useMemo
  ...
  // useEffect corrigé avec les bonnes dépendances
  useEffect(() => {
  ...
  }, [filteredCertifications]); // Utiliser filteredCertifications au lieu de filter
